...
if(isset($_POST['btnsave'])){
	...
	if(isset($_FILES['pic1'])){
	  ...
	  $sql = "insert into tbl_processfood (f_name,f_img,f_desc,p_id)values('".$txtname."','".$img1."','".$txtdesc."','".$txtSid."')";
	
	  $query = mysqli_query($conn,$sql);
	 if($query){
		header("location:processfood.php");
	 }else{
		 echo $sql;
	 }
...
if(isset($_GET['delete'])){
	...
	$photo = mysqli_query($conn,"select * from tbl_processfood where f_id=".$id);
	$prow = mysqli_fetch_assoc($photo);
	unlink("upload/".$prow['f_img']);
    $query = mysqli_query($conn,"delete from tbl_processfood where f_id=".$id);
	if($query){
		header("location:processfood.php");
	}
}
...
if(isset($_GET['edit_id'])){
	$id = $_GET['id'] ?? null;
	$query = mysqli_query($conn,"select * from tbl_processfood where f_id=".$id);
...
$sql = "update tbl_processfood set f_name='".$txtname."', f_desc='".$txtdesc."',f_img='".$img1."',p_id='".$txtpid."' where f_id=".$id;
            ...
            <div class="col-sm-10 col-md-10 col-lg-10">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"> Add Process Food </h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Name Process Food :</label>
                            ...
                            <div class="form-group">
                            <label>Detail Process Food & Packing :</label>
                ...
                ?>
                            <button type="reset" class="btn btn-danger"
                                onclick="window.location='processfood.php'">Cancel</button>
                ...
                <table class="table table-bordered  table-striped ">
					<thead>
                                        <tr>
                                            ...
                                            <th>Process Food Name</th>
                                            <th>Detail Process Food & Packing</th>                        
                                            <th>Product Type</th>
                                            <th>Image</th>
                                    ...
                                    <tbody>
                                        <?php
						$query = mysqli_query($conn,"select * from tbl_processfood order by f_id  ");
						while($row = mysqli_fetch_assoc($query)){
						?>
                                        <tr >
