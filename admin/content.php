...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js" referrerpolicy="origin"></script>
    <script src="https://tinymce.cachefly.net/4.2/tinymce.min.js" referrerpolicy="origin"></script>
    <!-- <script src="https://cdn.tiny.cloud/1/q9tvqo3pnpk18i7g60gdfo3kwvxkdg84lnblnbe6s2qn72gg/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script> -->
            ...
            <div class="col-sm-10 col-md-10 col-lg-10">
                    ...
                    <form role="form" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Name Fruit :</label>
                            ...
                            <label>Detail Fruit & Packing :</label>
                                <textarea class="form-control" rows="8" id="" name="txtdesc"
                                    id="txtdesc"><?php echo base64_encode($rowdesc); ?></textarea>
                ...
                ?>
                            <button type="reset" class="btn btn-danger"
                                onclick="window.location='fruit.php'">Cancel</button>
...
$start_from = ($page-1) * $limit;  
						$query = mysqli_query($conn,"select * from tbl_fruit order by f_id LIMIT $start_from, $limit   ");
						while($row = mysqli_fetch_assoc($query)){
						?>
                                        <tr>
...
$result_db = mysqli_query($conn,"SELECT COUNT(f_id) FROM tbl_fruit"); 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='fruit.php?page=".$i."'>".$i."</a></li>";	
}?>
<div class="card-footer clearfix">
 <ul class="pagination pagination-sm m-0 float-right">
